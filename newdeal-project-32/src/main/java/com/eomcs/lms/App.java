...
public class App {
	...
	public static void main(String[] args) {
		LessonHandler lessonHandler = new LessonHandler(keyboard, new com.eomcs.util.LinkedList<>());
		MemberHandler memberHandler = new MemberHandler(keyboard, new com.eomcs.util.ArrayList<>());
		BoardHandler boardHandler1 = new BoardHandler(keyboard, new com.eomcs.util.LinkedList<>());
		BoardHandler boardHandler2 = new BoardHandler(keyboard, new com.eomcs.util.ArrayList<>());
